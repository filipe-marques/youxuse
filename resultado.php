...
$ac = htmlspecialchars(trim($_GET['activ']), ENT_QUOTES);
$pc = htmlspecialchars(trim($_GET['p']), ENT_QUOTES);

$hashpass2 = crypt($pc, $hass);

mysql_query("START TRANSACTION");
$sql = "UPDATE users SET active='" . $ac . "' WHERE password='" . $hashpass2 . "'";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <?php
            if (($consul)) {
                echo ("<div class=\"alert alert-success\"><h2><p class=\"text-center\">" . LABEL_RESULTADO_TEXT1 . " $num " . LABEL_RESULTADO_TEXT2 . "</p>");
                echo("<p class=\"text-center\"><a href=\"signin.php\">" . LABEL_RESULTADO_TEXT3 . "</a> " . LABEL_RESULTADO_TEXT4 . "</p></h2></div>");
                mysql_query("COMMIT");
            } else {
                echo ("<div class=\"alert alert-error\"><h2>" . LABEL_RESULTADO_TEXT5 . "</h2></div>");
