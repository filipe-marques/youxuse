...
<div class="container">
    <footer>
        <?php
            ...
            ?>
        <p class="text-center"><a href="freeopensoft.php"><?php echo LABEL_FOOTER_TEXT1;?></a> - <a href="terms.php"><?php echo LABEL_FOOTER_TEXT2;?></a> - <a href="conduta.php"><?php echo LABEL_FOOTER_TEXT3;?></a> - <a href="user.php?user=developer&contribute=yes"><?php echo LABEL_FOOTER_TEXT4;?></a> - <a href="faq.php"><?php echo LABEL_FOOTER_TEXT5;?></a></p>
        <p class="text-left">YouXuse&trade; &copy; 2013 v. 2.0.0 - Codename: Vitoria</p>
